...
//CS30
//
//A sketch that makes a interactive scene with basic shapes
//Move around your mouse to change the color of the car

float car;

PFont f;
color darkBlue = #FFCDA8;
color darkGrey = #525355;
color darkGrey2 = #53575F;
color lightGrey = #EDF2FF; 
color lightGrey2 = #E1E5F2;
